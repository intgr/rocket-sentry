...
- **Feature:** Activate request Transaction as current span ([#87](https://github.com/intgr/rocket-sentry/pull/87))

  This means any messages, spans, etc. emitted in request context are automatically associated with the request
  Transaction.
...
- **Dependency:** Update rust crate sentry to 0.46.0 ([#105](https://github.com/intgr/rocket-sentry/pull/105))


## [0.27.0] - 2025-10-08

- **Dependency:** Update rust crate sentry to 0.45.0 ([#101](https://github.com/intgr/rocket-sentry/pull/101))


## [0.26.0] - 2025-10-07

- **Dependency:** Update rust crate sentry to 0.44.0 ([#99](https://github.com/intgr/rocket-sentry/pull/99))
